...
## About <span class="text-accent"> Directory</span>
...
Directory is an app for connecting with fellow humans. No games, no fees, no secrets. We keep things simple to support people on their journey of
experiencing the wonderful diversity of human connection.
</p>
...
<div class="tag-row">
  ...
  <span class="tag" style="background-color: #be8359ff;">couples date</span>
...
Directory is mostly a one-gal operation. I grew up between Virginia and the Outer
Banks of North Carolina. Then I graduated with a degree in computer science from UNC
